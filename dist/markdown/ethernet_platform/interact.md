...
例如，统计捕获0引脚上脉冲高电平的触发间隔(返回值单位毫秒，假定脉冲初始为低电平)，一次捕获10秒，进行三次循环。结束后将结果返回给192.168.1.1的端口8000:
...
在第三十秒得到第三次循环的结果为，[8]
则在前10秒钟的时间里，一共发生了7次上升沿，第一次和第二次上升沿的时间间隔为12毫秒，第二次和第三次上升沿的时间间隔为16毫秒，以此类推。
在第10秒到第20秒的时间里，发生3次上升沿，时间间隔为别为10,11和23毫秒。
在第20秒到第30秒的时间里，发生1次上升沿，时间间隔为8毫秒。
